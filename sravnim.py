...
# файл из скрипта выгрузка из ЕГРН
    ...
    if 'Слияние' in a:
        ...
        messagebox.showwarning(title="ошибка", message='Вы вмвели не верные заголовки, программа не может создать ключь для слияния, в обоих файлах должны быть одинаковые названия заголовков проверте и введите правильно')
